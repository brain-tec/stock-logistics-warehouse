...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo-addon-product_route_profile>=16.0dev,<16.1dev',
        ...
        'odoo-addon-stock_move_auto_assign_auto_release_exclude_location>=16.0dev,<16.1dev',
        ...
        'odoo-addon-stock_vlm_mgmt_kardex>=16.0dev,<16.1dev',
